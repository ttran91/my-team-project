...
export class AuthService {
  ...
  constructor(private http: HttpClient) {
    ...
    this.signUpApi = 'http://localhost:3476/user';
    this.userAPi = 'http://localhost:3476/user/username';
    this.profileEditAPi = 'http://localhost:3476/user/profile';
    this.userSecurityInfoApi = 'http://localhost:3476/user/security/info/';
