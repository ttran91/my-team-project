...
export class AuthService {
  ...
  constructor(private http: HttpClient) {
    ...
    this.signUpApi = 'http://localhost:4401/user';
    this.userAPi = 'http://localhost:4401/user/username';
    this.profileEditAPi = 'http://localhost:4401/user/profile';
    this.userSecurityInfoApi = 'http://localhost:4401/user/security/info/';
